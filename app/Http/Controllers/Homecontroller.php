    ...
    public function reject_post($id)
{
    ...
    public function advert()
    {
        ...
        return view('home.advert',compact('ads','comments'));
    }
    ...
    public function comment_add(Request $request)
{
    ...
    $comment->name = $request->name; // Assign the user's name to the 'name' field
...
public function rate(Request $request, Post $post)
    ...
    {
        // Fetch top rated posts ordered by rating in descending order
        $topRatedPosts = Post::where('status', 'Active')
            ->orderByDesc('rating')
            ->limit(3) // Adjust this limit according to your requirement
            ->get();

        // Pass $topRatedPosts to the view
