        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 mb-5 text-center">
                    ...
                    <p><a href="{{route('post_auction')}}" class="btn btn-primary py-3 px-4">Add Auction</a></p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-md-4">
                        <div class="property-wrap ftco-animate">
                            ...
                            <div class="text">
                                ...
                                <h3 class="mb-0"><a href="{{ url('single2',$auction->id) }}">{{ $auction->name }}</a></h3>
                                ...
                                <ul class="property_list">
                                    ...
                                    <li><a href="{{{ route('bid_auction', $auction->id) }}}" class="btn-buy-now">Bid Now</a>
</li>
                                </ul>
                            </div>
                        </div>
